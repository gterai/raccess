 ...
 */
#ifndef RACCESS__RACCESS_CONTRAFOLD_HPP
#define RACCESS__RACCESS_CONTRAFOLD_HPP
#include "util/util.hpp"
#include "raccess/score_model_contrafold_v202.hpp"
#include "raccess/prob_model.hpp"
namespace Raccess { class RaccessContrafold;}
class Raccess::RaccessContrafold {
public:
  typedef RaccessContrafold        Self;
  ...
  public:
    RaccessContrafold* _r;
    ostream*       _fo;
    IntT*          _i0;
    PrintEnergyRow(RaccessContrafold& r, ostream& fo, IntT& i0) : _r(&r), _fo(&fo), _i0(&i0) {}
    void init() { (*_i0) = (-1);}
    void finish() { 
      if (_r->table_format()) { 
	// no op
...
#define opt_items()  \
  ...
  opt_item(bind_range      , string, "none"           , "not available") \
  ...
  opt_item_(bed_header      , bool  , "true"           , "") \
  opt_item_(table_format    , bool  , "false"          , "") \
  opt_item_(bind_dna        , bool  , "false"          , "not available")
